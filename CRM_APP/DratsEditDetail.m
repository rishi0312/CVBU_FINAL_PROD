 ...
 self.txt_Vehicleapplication.text=[self.draftsdetail valueForKey:@"application"];
  ...
  // self.txt_contactemailid.text=[self.draftsdetail valueForKey:@"contactmail"];
    ...
    */
    ...
    NSLog(@"values address %@,%@,%@,%@",geoCodiingObject.State,geoCodiingObject.District,geoCodiingObject.City,geoCodiingObject.Taluka);
    
    
    _account_pickfromgps.enabled=YES;
    _contact_pickfromgpps.enabled=YES;
