        ...
        case 1:
            if (buttonIndex == actionSheet.cancelButtonIndex) {
                ...
                if ([_txt_LOB.text isEqualToString:@"Buses"]) {
                    ...
                    [self hideAlert];
                    alert = [[UIAlertView alloc] initWithTitle:nil message:@"Mendatory to create account" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
                    [alert setTag:0];
                    [alert show];
        ...
        if ([_txt_LOB.text isEqualToString:@"I&MCV Trucks"]) {
...

            {
                ...
                if (![self.accountconfirmationbtnoutlet isOn]) {
                    ...
                    alert = [[UIAlertView alloc] initWithTitle:nil message:@"Enable account creation" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
                    [alert setTag:0];
                    [alert show];
                }


              else  if ([_txt_accountName.text isEqualToString:@""]) {
                    [self hideAlert];
                    
                    alert = [[UIAlertView alloc] initWithTitle:nil message:@"Account creation mendatory" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
                    [alert setTag:0];
                    [alert show];
                }
                else if ([_txt_mobilenumber.text isEqualToString:@""])
                ...
                else if ([_txt_site.text isEqualToString:@""]) {
                    [self hideAlert];
